...
export default class About extends Component {
  ...
  render() {
    return (
      ...
      >
        <StyledSection key="animation">
          <article className="center mw7">
            <GradientDiv>
              <StyledText className="tracked lh-copy f4-ns f5 fw9 mv1-ns ml0-l ml4 mr0-l mr4">
                I'm a uniquely balanced human who approaches complex problems
                with a critical eye and curious spirit. Coffee in hand, I strive
                to build reliable, user-focused products. My enthusiasm for
                programming is fueled by an unshakable vision of a more
                inclusive society. My tool belt includes, but isn't limited to,
                all things Javascript/ES6, HTML5/CSS3, React, Node, Express,
                Webpack, MySQL/NoSQL, Git and project management. I've
              ...
              <ReadMore showMore={this.state.showMore}>
                <ReadMoreP className="tracked lh-copy f4-ns f5 fw9 mv1-ns ml0-l ml4 mr0-l mr4">
                  ...
                  Those I've collaborated with describe me as reliable,
                  empathetic and resolute. When not coding I'm adventuring
                  about, experimenting in the kitchen, or indulging my feline in
                  some one-on-one time. Personally, there's nothing more
                  gratifying than rallying together to transform a
                  forward-focused thought into code...besides the sporadic
                  spoonful of sunflower seed butter. Seriously, try it!{" "}
                </ReadMoreP>
              </ReadMore>
            </GradientDiv>
          </article>
